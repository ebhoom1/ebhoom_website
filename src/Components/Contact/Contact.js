          ...
          <div className="container">
            <div className="row">
              <div className="col-12 mb-3">
                <h1 className="services-head1 mb-3">Feel free to Contact us</h1>
              </div>
              ...
              <div className="col-12 col-lg-6 mb-3">
                <div className="silver-box">
                  <h3 className="silver-box-head">Email</h3>

                  <a className="link" href="mailto:info@ebhoom.com">
                    {" "}
                    <p className="silver-box-desc">info@ebhoom.com</p>
                  </a>
                </div>
              </div>
              ...
              <div className="col-12 col-lg-6 mb-3">
                <div className="silver-box">
                  <h3 className="silver-box-head">Social</h3>
                  <a
                    className="link pe-3 text-blue"
              ...
              <iframe frameborder="0" className="form-style" src='https://forms.zohopublic.in/infoebhoom/form/ContactUs/formperma/GLIiLreuAa-hUQD9zcaA3G2kwoe4Rdlvw2awM1CmHfI'></iframe>
              </div>
            </div>
          </div>
        </div>
