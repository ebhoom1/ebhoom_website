            ...
            <div className='row'>
                ...
                <div className='col-12 col-lg-3 mb-3'>
                  ...
                  <span className="badge bg-warning mb-3">Available</span>
                    <img className='w-100 mb-3' src='assets/images/device_1.jpg' alt="Ebhoom" />
                    
                    <h5 className='mb-2 text-blue ebhoom-txt'>OCEMS MARS</h5>
                    <p className='mb-3 store-desc'> A complete solution for backend monitoring and control of your
                  treatment plant</p>
                    <button className='book-button' type='button' data-bs-toggle="modal" data-bs-target="#exampleModal">Order Now</button>
